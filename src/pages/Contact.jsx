    ...
    <>
       <Box sx={{ my: 5, ml: 10, "& h4": { fontWeight: "bold", mb: 2 } }}>
        <Typography variant="h4" sx={{ "@media (max-width:600px)": {
          fontSize: "30px", marginRight:"50px"
          }}}>Contact The Urban Lights</Typography>
        ...
        <TableContainer component={Paper}>
          <Table aria-label="contact table">
            <TableHead>
              <TableRow>
                <TableCell
                  sx={{ bgcolor: "black", color: "white" ,fontSize:"30px"}}
                  align="center"
                >
                  Contact Details
                </TableCell>
            ...
            <TableBody>
              <TableRow>
                <TableCell>
                  <SupportAgentIcon sx={{ color: "red", pt: 1 }} /> 20200202020
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                  <MailIcon sx={{ color: "skyblue", pt: 1 }} /> supporturbanlight@gmail.com
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
